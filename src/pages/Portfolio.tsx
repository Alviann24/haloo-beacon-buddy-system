        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-16 max-w-md mx-auto">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              <div className="bg-gradient-to-br from-purple-400/30 to-pink-400/30 rounded-xl aspect-square mb-4 flex items-center justify-center">
                <div className="text-6xl">📱</div>
              </div>
              
              <div className="flex items-center justify-between mb-4">
                <div className="flex space-x-4">
                  <button className="text-white hover:text-red-400 transition-colors">❤️</button>
                  <button className="text-white hover:text-blue-400 transition-colors">💬</button>
                  <button className="text-white hover:text-green-400 transition-colors">📤</button>
                </div>
              ...
              <div className="flex items-center justify-center space-x-6 text-white/60 mt-4">
